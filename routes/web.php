...
Route::get('anh-cong-trinh', 'IndexController@anhcongtrinh');
Route::get('cong-trinh/{alias}.html', 'IndexController@detailCongTrinh');
Route::get('cong-trinh/{alias}', 'IndexController@listCongTrinh');
